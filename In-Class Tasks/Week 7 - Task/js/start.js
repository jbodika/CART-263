...
function go_all_stuff() {
    ...
    drawingBoardB.addObj(new RectangularObj(100, 100, 50, 70, "#FF5733", "#E6E6FA",2,2, drawingBoardB.context))
     ...
     *  1: Affect the rectangle by ANY TYPE OF input from the microphone somehow, in real time...
